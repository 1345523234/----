...
import UserFuXi from '../views/test/user-fuxi/user-model'
Vue.use(Vuex)
// 根据登录用户的角色id获取菜单列表
...
import UserType from './user-type/index.js'
import Goods from './goods-model'
import GoodsMender from './goodsMemder'
import Coupon from './coupon'
import NewsModel from './newsModel'
import Order from './order'
import CheckScope from './check-scope/index.js'
