<template>
  <div>
    <PageHeader title="会员管理"></PageHeader>
    <el-button type="primary" icon="el-icon-plus"
    @click="$router.push('/user-type-add')"
...
export default {
    ...
    methods:{
        ...mapActions('userType',['getList','delData']),
        // async getList(){
       ...
       async getPageData(num){
        ...
        await this.$store.dispatch('userType/getPageData',this.page)
    ...
    computed:{
        ...mapState('userType',['list','pageInfo']),
        ...mapGetters('userType',['pageListData'])
    },
    components:{
        PageHeader
    }
