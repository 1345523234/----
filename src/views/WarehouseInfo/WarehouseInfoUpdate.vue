<template>
  <div>
    ...
    >
      ...
      <el-form-item label="仓库地址" prop="CompanyName" size="mini">
...
export default {
  ...
  async created() {
    ...
    this.form = await this.getWarehouseInfoFindId(this.$route.query.id)
  ...
  methods: {
    ...mapActions("warehouseInfo", [ "getWarehouseInfoUpdate","getWarehouseInfoFindId" ]),
      ...
      async submit(){
         try{
            this.$refs.form.validate(async valid=>{
              ...
              let data =  await  this.getWarehouseInfoUpdate(this.form)
           if(data){
               this.$message({
                   type:'success',
                   duration:500,
